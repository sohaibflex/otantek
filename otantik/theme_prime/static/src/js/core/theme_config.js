...
'use strict';
    ...
    var ThemeOptionLoadMoreProductOnClick = AbstractThemeOption.extend({
        option_template: 'theme_config.ajaxLoadProductsOnClick',
        key: 'bool_enable_ajax_load_on_click',
        events: { change: '_onChange' },
        _onChange: function (ev) {
            this.setValue(this.$('#bool_enable_ajax_load_on_click').prop('checked'));
        }
    });
    ...
    var ThemeConfigDialog = Dialog.extend({
        ...
        _tabInfo: function () {
            return [{
                ...
                label: _t('Shop'),
                widgets: [ThemeOptionGridProduct, ThemeOptionShopFilters, ThemeOptionCategoryPills, ThemeOptionAjaxLoadProducts, ThemeOptionLoadMoreProductOnClick]
            }, {
