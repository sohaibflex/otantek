...
BEGIN
    Return Query
    Select
        T.company_id, cmp.name as company_name, T.product_id, case when prod.default_code is not null then
    ...
    (
        ...
        group by wh.company_id,pro.id,pt.categ_id,wh.id
    )T
