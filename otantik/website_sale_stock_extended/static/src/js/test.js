odoo.define('product_template_modification.variant_mixin_update', function (require) {
'use strict';
...
//    alert("loaded")
    ...
    if (combination.product_type === 'product' && _.contains(['always', 'threshold', 'hide'], combination.inventory_availability)) {
