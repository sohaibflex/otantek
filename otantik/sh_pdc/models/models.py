...
class AccountInvoice(models.Model):
    ...
    def open_pdc_payment(self):
        [action] = self.env.ref('sh_pdc.sh_pdc_payment_menu_action').sudo().read()
...
#         return reconciled_vals
    ...
    pdc_id = fields.Many2one('pdc.wizard')
    pdc_payment_ids = fields.Many2many('pdc.wizard',compute='_compute_pdc_payment_invoice',store=True)
