...
class all_loyalty_setting(models.Model):
	...
	multi_company_ids = fields.Many2many('res.company','rel_settings_history','setting_id','history_id',string="Allowed Companies",domain=lambda self: [("id", "in", self.env.companies.ids)])
